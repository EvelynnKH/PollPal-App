...
class SurveyQuestionViewModel: ObservableObject {
    ...
    private func loadQuestions() {
        if let questionSet = survey.has_question as? Set<Question> {
            self.questions = questionSet.sorted {
                // Kita gunakan 'distantPast' sebagai nilai default jika tanggalnya nil
                // agar aplikasi tidak crash pada data lama.
                let date1 = $0.question_created_at ?? Date.distantPast
                let date2 = $1.question_created_at ?? Date.distantPast

                // Urutkan dari yang Terlama -> Terbaru (1, 2, 3...)
                return date1 < date2
            }
        }
    }
    ...
    var currentQuestionImage: String? {
        ...
        guard let imgName = currentQuestion?.question_img_url, !imgName.isEmpty
        else {
            return nil
        }
        return imgName
        ...
        viewContext.performAndWait {
            ...
            for question in questions {
                ...
                // --- CASE 3: TEXT ---
                    ...
                    if let textContent = text,
                        !textContent.trimmingCharacters(
            ...
            if rewardPoints > 0 {
                ...
                trans.transaction_description =
                    "Reward Survey: \(survey.survey_title ?? "Untitled Survey")"
                ...
                print(
                    "User \(user.user_name ?? "Unknown") new point total: \(user.user_point)"
                )
            } else {
            ...
            do {
                ...
                print(
                    "✅ Survey submission and reward transaction saved successfully."
                )
            } catch {
