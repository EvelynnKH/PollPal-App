    ...
    func calculateTotalBaseCost() -> Int {
        ...
        for question in questions {
               ...
               let type = QuestionType(rawValue: typeString)
            {
                ...
                print("⚠️ Unknown question type for question: \(question.question_text ?? "No Text"). Using default cost 10.")
    ...
    private var contentDetail: some View {
        VStack(alignment: .leading, spacing: 25) {  // Spacing antar section diperbesar sedikit
            ...
            VStack(alignment: .leading, spacing: 15) {
                ...
                // 4. Domicile
                VStack(alignment: .leading, spacing: 8) {
                    Text("Target Birth Place").font(.caption).foregroundColor(
                        .gray
                    )
            ...
            Button {
                if isInputValid() {
                    ...
                    if publishSuccessful {
                        ...
                        vm.recordSurveyCostTransaction(for: survey, cost: pointsRequired)
    ...
    private var costReceiptSection: some View {
        VStack(alignment: .leading, spacing: 4) {
            ...
            VStack(spacing: 6) {
                ...
                HStack {
                    Text("Survey Cost (\(targetRespondentCount) x \(baseCostPerRespondent) pts)")
                        .font(.subheadline)
